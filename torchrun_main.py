...
def evaluate_model(model, preprocess_batched, pad_idx, global_rank, world_size, device, batch_size):
    _time = time.time()
    val_data = datasets.load_dataset("c4", "en", split="validation", trust_remote_code=True) # streaming=True) #DGX
...
def main(args):
    ...
    data = datasets.load_dataset("allenai/c4", "en", split="train", trust_remote_code=True) # , streaming=True)
